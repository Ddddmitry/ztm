  ...
  if (rangeCost) {
    ...
    $body.on('click', '.show-cost', function (e) {
      ...
      if ($(window).width() < 768) {
        ...
        modalPriceForm = $('.modal-cost__form-m-js');
      } else {
        openModal('modal-cost');
        modalPriceForm = $('.modal-cost__form-js');
      }
      modalPriceForm.find("input[type='hidden']").remove();
      modalPriceForm.append("<input type='hidden' name='from' value='"+$(this).attr("data-from")+"'>");
      modalPriceForm.append("<input type='hidden' name='to' value='"+$(this).attr("data-to")+"'>");
      modalPriceForm.append("<input type='hidden' name='days' value='"+$(this).attr("data-days")+"'>");
      modalPriceForm.append("<input type='hidden' name='delivery_price' value='"+$(this).attr("data-delivery_price")+"'>");
      modalPriceForm.append("<input type='hidden' name='sum_price' value='"+$(this).attr("data-sum_price")+"'>");
      modalPriceForm.append("<input type='hidden' name='until' value='"+$(this).attr("data-until")+"'>");
      modalPriceForm.append("<input type='hidden' name='weight' value='"+$(this).attr("data-weight")+"'>");
      modalPriceForm.append("<input type='hidden' name='volume' value='"+$(this).attr("data-volume")+"'>");
